...
function InAppWalletConnectUI(props) {
    ...
    const state = data;
    const localeQuery = (0, useInAppWalletLocale_js_1.useInAppWalletLocale)();
    ...
    const otpUserInfo = state?.emailLogin
        ...
        : state?.phoneLogin
            ...
            : undefined;
    if (otpUserInfo) {
        return ((0, jsx_runtime_1.jsx)(InAppWalletOTPLoginUI_js_1.InAppWalletOTPLoginUI, { userInfo: otpUserInfo, locale: localeQuery.data, done: props.done, goBack: goBackToMain, wallet: props.wallet }));
    }
    ...
    if (state?.socialLogin) {
        return ((0, jsx_runtime_1.jsx)(InAppWalletSocialLogin_js_1.InAppWalletSocialLogin, { socialAuth: state.socialLogin.type, locale: localeQuery.data, done: props.done, goBack: goBackToMain, wallet: props.wallet, state: state }));
    }
    return ((0, jsx_runtime_1.jsx)(InAppWalletFormUI_js_1.InAppWalletFormUIScreen, { select: () => { }, locale: localeQuery.data, done: props.done, goBack: props.goBack, wallet: props.wallet }));
}
