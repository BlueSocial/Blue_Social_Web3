...
function InAppWalletSelectionUI(props) {
    ...
    return ((0, jsx_runtime_1.jsx)(InAppWalletFormUI_js_1.InAppWalletFormUI, { locale: localeQuery.data, wallet: props.wallet, done: props.done, select: props.select, goBack: props.goBack }));
}
