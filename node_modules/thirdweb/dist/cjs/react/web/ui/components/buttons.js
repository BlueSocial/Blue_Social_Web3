...
exports.Button = (0, elements_js_1.StyledButton)((props) => {
    const _theme = (0, CustomThemeProvider_js_1.useCustomTheme)();
    const theme = (0, CustomThemeProvider_js_1.isValidTheme)(props.theme) ? (0, CustomThemeProvider_js_1.parseTheme)(props.theme) : _theme;
    if (props.unstyled) {
        return {};
    }
    return {
