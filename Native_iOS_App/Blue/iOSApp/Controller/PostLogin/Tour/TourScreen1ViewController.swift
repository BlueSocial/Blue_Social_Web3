...
class TourScreen1ViewController: BaseVC {
    ...
    override func viewDidLoad() {
        ...
        UserLocalData.lastOpenedTourScreen = 0
        self.prepareTourScreen1()
    }
    ...
    //                       MARK: - View Methods -
    // ----------------------------------------------------------
    private func prepareTourScreen1() {
        
        guard let path = Bundle.main.path(forResource: "TourScreenPanel1", ofType: "mp4") else { return }
...
//                       MARK: - Action -
// ----------------------------------------------------------
extension TourScreen1ViewController {
