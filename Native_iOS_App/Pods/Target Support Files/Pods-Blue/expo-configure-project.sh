...
with_node \
  ...
  --target "/Users/ethan/Desktop/ThirdwebReact copy/ReactNativeApp/Native_iOS_App/Pods/Target Support Files/Pods-Blue/ExpoModulesProvider.swift" \
  --platform "apple" \
  --packages "@coinbase/wallet-mobile-sdk" "expo-application" "expo-asset" "expo-constants" "expo-file-system" "expo-font" "expo-keep-awake" "expo-web-browser"
