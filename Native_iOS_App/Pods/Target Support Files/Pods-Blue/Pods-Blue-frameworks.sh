...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-aes-gcm-crypto/react_native_aes_gcm_crypto.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/react-native-quick-crypto/react_native_quick_crypto.framework"
